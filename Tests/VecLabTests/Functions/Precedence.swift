...
PrecedenceTests: XCTestCase {
    ...
    func testMixedOperatorsWithDivisionSubtractionAndExponentiation() {
        ...
        let result = a / b - 2.0 ** 2.0
        print(result)
        XCTAssertEqual(result, [-3.500000000000000,  -3.333333333333333,  -3.250000000000000,  -3.200000000000000],
                       accuracy: accuracy) // Power first, then division, then subtraction
    }
