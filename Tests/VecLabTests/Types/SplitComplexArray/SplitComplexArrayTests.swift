...
final class SplitComplexArrayTests: XCTestCase {
    ...
    func testCollectionOperations() {
        ...
        for element in array {
            sum = Complex(sum.real + element.real, sum.imag + element.imag)
        }
    ...
    func testRangeOperations() {
        ...
        // Range subscript set
        array[1..<3] = [Complex(30, 40), Complex(50, 60)]
    ...
    func testRangeReplaceableOperations() {
        ...
        // Append contentsOf
        array.append(contentsOf: [Complex(3, 4), Complex(5, 6)])
        XCTAssertEqual(array.count, 3)
        XCTAssertEqual(array[2].imag, 6)

        // Insert
        array.insert(Complex(7, 8), at: 1)
        ...
        // ReplaceSubrange
        // array.replaceSubrange(0..<1, with: [Complex(9, 10), Complex(11, 12)])
