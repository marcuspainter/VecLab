...
public func vectorf(count: Int) -> RealFloatArray {
...
public func vectorf(_ x: [Int]) -> RealFloatArray {
...
/// - Returns: A real array.
public func vectorf(_ x: [Float]) -> RealFloatArray {
    return x.map { Float($0) }
}
...
/// - Returns: A real array.
public func vectorf(_ x: [Double]) -> RealFloatArray {
    return x.map { Float($0) }
}
...
/// - Returns: A real array.
public func vectorf(_ range: Range<Int>, _ strideValue: Int = 1) -> RealFloatArray {
...
///   - strideValue: Optional stride value. Default 1.
/// - Returns: A real array.
public func vectorf(_ range: Range<RealFloat>, _ strideValue: RealFloat = 1) -> RealFloatArray {
    let stridedValues = stride(from: range.lowerBound, to: range.upperBound, by: strideValue)
    return stridedValues.map { Float($0) }
}
...
///   - strideValue: Optional stride value. Default 1.
/// - Returns: A real array.
public func vectorf(_ range: ClosedRange<RealFloat>, _ strideValue: RealFloat = 1) -> RealFloatArray {
...
///   - strideValue: Optional stride value. Default 1.
/// - Returns: A real array.
public func vectorf(_ range: ClosedRange<Int>, _ strideValue: Int = 1) -> RealFloatArray {
    let stridedValues = stride(from: range.lowerBound, through: range.upperBound, by: strideValue)
    return stridedValues.map { Float($0) }
}
...
public func vectorf(sized: RealFloatArray) -> RealFloatArray {
...
public func vectorf(sized: ComplexDoubleArray) -> RealFloatArray {
